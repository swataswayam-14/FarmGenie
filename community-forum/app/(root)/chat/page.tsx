...
import { makeRequest } from "@/lib/actions/chat";
        ...
        <div className="min-h-screen bg-gray-900 text-white font-sans flex">
            <div className="w-3/4 p-5">
                ...
                <main className="flex flex-col items-center justify-center flex-1 px-4 md:px-0">
                    <div className="w-full md:w-3/4 lg:w-2/3 bg-gray-800  shadow-lg p-4 mb-6 overflow-y-auto" style={{ maxHeight: '400px' }}>
                        Chatbot messages will be displayed here
                    </div>
                    <div className="mr-20 mb-4">
                        <button className="px-2 py-1 rounded-lg ml-5 bg-white text-black font-semibold" onClick={() => {
                            setTranslate(true);
                        }}>Hindi</button>
                        <button className="px-2 py-1 rounded-lg ml-5 bg-white text-black font-semibold" onClick={() => {
                            setTranslate(false);
                    ...
                    <div className="w-full md:w-3/4 lg:w-2/3 flex items-center">
                        <textarea
                            className="w-full h-16 p-4 rounded-lg bg-gray-800 text-white text-lg resize-none shadow-lg"
                        ...
                        <Button
                            type="submit"
                            className="rounded-r-lg bg-green-500 hover:bg-green-600 text-white font-bold ml-2 py-2 px-4"
                            onClick={submit}
                        >
                            Submit
                        </Button>
            ...
            <div className="w-1/4 bg-gray-800 p-5 overflow-y-auto rounded-t-lg rounded-b-lg" style={{ maxHeight: '100vh' }}>
                ...
                {chatHistory?.length === 0 ? (
                    ...
                    chatHistory?.map((item: HistoryItem, index) => (
