...
export function OrderInfomation({order, product, downloadVerificationId}: OrderInformationProps){
    ...
    <Section className="border border-solid border-gray-500 rounded-lg p-4 md:p-6 my-4">
        ...
        <Row className="mt-8">
            ...
            <Column align="right">
                <Button href={`${process.env.NEXT_PUBLIC_SERVER_URL}/marketplace/products/download/${downloadVerificationId}`} className="bg-black text-white px-6 py-4 rounded text-lg">Download</Button>
            </Column>
        </Row>
        <Row>
